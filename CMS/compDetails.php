...
<form action="processLeave.php?action=addUser" method="post"  name="frmListUser" id="frmListUser">
  <table width="100%" border="0" align="center" cellpadding="2" cellspacing="1" class="text">
    <tr align="center" id="listTableHeader">
      ...
      <td width="139">Assign Date</td>
      <td width="139">Working Date</td>
      <td width="139">Close Date</td>
    ...
    <tr class="<?php echo $class; ?>" style="height:25px;">
      ...
      <td width="139" align="center"><?php echo ucwords($create_date); ?></td>
      <td width="139" align="center"><?php echo ucwords($work_date); ?></td>
      <td width="139" align="center"><?php echo ucwords($close_date); ?></td>
