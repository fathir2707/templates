...
<form action="processLeave.php?action=addUser" method="post"  name="frmListUser" id="frmListUser">
  <table width="100%" border="0" align="center" cellpadding="2" cellspacing="1" class="text">
    <tr align="center" id="listTableHeader">
      ...
      <td width="260">Assign Date</td>
      <td width="260">Work Date</td>
     
    </tr>
    <?php
	$cust_id = (int)$_SESSION['user_id'];
	$sql = "SELECT comp_title, eng_name, cust_name, status, create_date, work_date
			FROM tbl_complains
			WHERE status != 'close'
			AND  eng_name != ''
    ...
    <tr class="<?php echo $class; ?>" style="height:25px;">
      ...
      <td width="260" align="center"><?php echo ucwords($create_date); ?></td>
      <td width="260" align="center"><?php echo ucwords($work_date); ?></td>
